...
const CONSUMER_KEY = "WP_consumer_key";
const CONSUMER_SECRET = "WP_consumer_secret"
const PROJECT_URL = "https://sunilk.work/"
const API_URL = PROJECT_URL + "wp-json/wc/v3"
const WP_USER_API_URL = `${PROJECT_URL}wp-json/wp/v2/users`

//Let's generate OAuth signature for WP API Handshake
...
// Get all Products from Server hosted WooCommerce Plugin
